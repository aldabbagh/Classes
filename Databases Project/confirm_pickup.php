...
$id = mysqli_real_escape_string($db, $_REQUEST['id']);
			...
			$query = "SELECT pickup_clerk_username, C.first_name AS cFirstName, C.middle_name As cMiddleName,
			...
			Cl.username = pickup_clerk_username)
  ...
  <div class="col-12">
    ...
    <h1 class="h2">Reservation Confirmation</h2>
      <dl class="row">
		...
		<dt class="col-sm-3 col-lg-2 text-info">Pickup Clerk</dt>
        <dd class="col-sm-9 col-lg-10">
        ...
        <dt class="col-sm-3 col-lg-2">Credit Card #</dt>
        <dd class="col-sm-9 col-lg-10">
          <?php print($rowRental['card_number']) ?>
        </dd>
  ...
  <table class="table table-sm table-hover">
    ...
    <tbody>
	  ...
	  <?php 
		...
		$query = "SELECT tool_number, power_source, sub_option, sub_type, price
		...
		if (isset($result)) {
			...
			print("<th scope=\"col\">".round($tdp,2)."</td>");
			print("<th scope=\"col\">".round($trp,2)."</td>");
			print("</tr>");
	  ...
	  print("Date: ".explode(" ",$rowRental['start_date'])[0]);	  ?>
	  <br>
	  <br>
	  	  <input type="text" style="border: 0 ; border-bottom: 1px solid #000;" disabled />
	  <br>
