...
ax = testing_data_out_sample[symb].plot(title = 'My Strategy ML4T Out Sample Prices',label='ML4T-220 Price', fontsize=12, legend=True)
ax.set_xlabel("Date")
ax.set_ylabel("Price")
...
plt.savefig("My Strat out sample ml4t.png", dpi=200)
plt.show()
plt.close()
...
ax2 = testing_data_out_sample[symb].plot(title = 'My Strategy ML4T Out Sample', fontsize=12, legend=True)
ax2.set_xlabel("Date")
...
plt.savefig("My Strat out sample ml4t entry exit.png", dpi=200)

csv_data = to_csv[['Symbol', 'Order', 'Shares']]
csv_data.to_csv("./my_order_out_sample_ml4t.csv",index_label='Date')

of = "./my_order_out_sample_ml4t.csv"
...
ax = df_temp.plot(title = 'Daily portfolio value and $SPX ML4T Out Sample', fontsize=12, legend=True)
ax.set_xlabel("Date")
ax.set_ylabel("Normalized price")
plt.grid()
plt.savefig("Daily portfolio value and $SPX - My Strat ML4T Out Sample Backtest.png")
plt.show()
