...
ax = training_data[symb].plot(title = 'My Strategy IBM In Sample Prices',label='IBM Price', fontsize=12, legend=True)
ax.set_xlabel("Date")
ax.set_ylabel("Price")
...
plt.savefig("My Strat IBM in Sample.png", dpi=200)
plt.show()
plt.close

ax2 = training_data[symb].plot(title = 'My Strategy IBM Entry Exit', fontsize=12, legend=True)
ax2.set_xlabel("Date")
...
plt.savefig("My Strat IBM in Sample Entry Exit.png", dpi=200)

csv_data = to_csv[['Symbol', 'Order', 'Shares']]
csv_data.to_csv("./my_order_IBM.csv",index_label='Date')
...
ax = df_temp.plot(title = 'Daily portfolio value and $SPX IBM in Sample', fontsize=12, legend=True)
ax.set_xlabel("Date")
ax.set_ylabel("Normalized price")
plt.grid()
plt.savefig("Daily portfolio value and $SPX - My Strat IBM in Sample Backtest.png")
plt.show()
